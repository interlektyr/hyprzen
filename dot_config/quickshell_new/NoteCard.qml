...
Rectangle {
          ...
          scale: visible ? 1 : 0
          visible: false
          border.width: isSelected && !ZenServices.passiveNoteWidget ? 2 : 0
          ...
          Column {
            ...
            Column {
              ...
              width: parent.width
              spacing: 2
              visible: modelData.actions.length > 0 && !ZenServices.passiveNoteWidget && isSelected ? true : false
            ...
            Text {
              ...
              //visible: noteDelegate.isSelected || root.passiveWidget ? true : false
              //visible: isSelected ? true : false
              visible: modelData.actions.length > 0 && ZenServices.passiveNoteWidget ? true : false
            }
          } //Column one
